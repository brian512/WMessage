...
public class DeviceUtil {
    ...
    public static float getScreenWHRatio(Context context) {
        return getScreenWidth(context) * 1f / getScreenHeight(context);
    }
    ...
    public static int getStatusHeightNew(Context context) {
        ...
        int sbar = DipPixelUtil.dip2px(24);
        try {
    ...
    public static String getMobileNum(Context context) {
        ...
        if (PermissionUtil.hasPermissions(context, Manifest.permission.READ_PHONE_STATE)) {
            try {
                mobileNum = telMg.getLine1Number();
            } catch (Exception e) {}
        }
        if (mobileNum == null) {
            mobileNum = "";
    ...
    static public boolean isExternalStorageEmulated() {
        return Environment.isExternalStorageEmulated(); // SDK版本号要高于11才能用
    }
    ...
    static public boolean isExternalStorageRemovable() {
        return Environment.isExternalStorageRemovable(); // SDK版本号要高于11才能用
    }
    ...
    public static String getSerialId(Context context) {
        ...
        String seria_num = getSystemProperty("ro.serialno");
    ...
    public static boolean isSimulator() {
        try {
            ...
            String imei = getIMEI(Env.getContext());
    ...
    public static boolean hasNavigationBar() {
        if (sHasNavigationBar != -1) {
            return sHasNavigationBar == 0;
        }
        Resources rs = Env.getContext().getResources();
        int id = rs.getIdentifier("config_showNavigationBar", "bool", "android");
        if (id > 0) {
            sHasNavigationBar = rs.getBoolean(id) ? 0 : 1;
        }
        ...
        LogUtil.log("sHasNavigationBar=" + (sHasNavigationBar==0));
        return sHasNavigationBar == 0;
    }
