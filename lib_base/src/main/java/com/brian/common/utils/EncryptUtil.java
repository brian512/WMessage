...
public class EncryptUtil {
    ...
    public static String encryptAES(String data, String key) {
        LogUtil.d("data=" + data + "; key=" + key);
        byte[] result = desTemplate(data.getBytes(), Md5Util.getMD5(key).getBytes(), AES_Algorithm, AES_Transformation, true);
    ...
    public static String decryptAES(String data, String key) {
        byte[] result = desTemplate(data.getBytes(), Md5Util.getMD5(key).getBytes(), AES_Algorithm, AES_Transformation, false);
        return new String(result);
    }
